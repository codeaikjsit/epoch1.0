      ...
      <div className="dark-nav-wrap">
        ...
        <div className="dark-header-actions">
          <a
            ...
            href="https://unstop.com/o/5eHbsKX?lb=use8IGCp&utm_medium=Share&utm_source=online_coding_challenge&utm_campaign=Pradnpat10374"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="dark-mobile-menu">
          <nav className="dark-mobile-nav">
            ...
            <div className="dark-mobile-buttons">
              <a
                className="header-register dark-mobile-register"
                href="https://unstop.com/o/5eHbsKX?lb=use8IGCp&utm_medium=Share&utm_source=online_coding_challenge&utm_campaign=Pradnpat10374"
                target="_blank"
                rel="noopener noreferrer"
